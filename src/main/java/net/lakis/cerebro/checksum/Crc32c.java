...
/**
 * Implements CRC32-C as defined in: "Optimization of Cyclic Redundancy-CHeck
 * Codes with 24 and 32 Parity Bits", IEEE Transactions on Communications 41(6):
 * 883-892 (1993).
 *
 * The implementation of this class has been sourced from the Appendix of RFC
 * 3309, but with masking due to Java not being able to support unsigned types.
 */
public class Crc32c implements Checksum {
	private static final int[] CRC_TABLE = { 0x00000000, 0xF26B8303, 0xE13B70F7, 0x1350F3F4, 0xC79A971F, 0x35F1141C,
